...
&& isset($_POST['checks']) != ''  && isset($_POST['finalresult']) != '' && isset($_POST['status']) != '')
 {
                                ...
                                <hr>
                                    <div class="row mt-4">
                                      ...
                                      <table class="table table-bordered table-hover table-sm">
                                            ...
                                            <tbody class="p-0 m-0">
                                                <tr>                                              
                                                <td class="text-center "><input tabindex="49" id="checks" name="checks" type="checkbox" value="Yes"  <?php if(isset($checks)==0){echo'checked';}?>></td>
